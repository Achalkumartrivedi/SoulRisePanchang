...
exports.NAKSHATRA_MAP = exports.NATURE_BADGE_MAP = exports.PAKSHA_MAP = exports.VAARA_MAP = exports.TITHI_MAP = void 0;
exports.getLocalizedTithi = getLocalizedTithi;
exports.getLocalizedPakshaName = getLocalizedPakshaName;
exports.getLocalizedNatureBadge = getLocalizedNatureBadge;
exports.getLocalizedNakshatra = getLocalizedNakshatra;
...
function getLocalizedPakshaName(paksha, language) {
    ...
    const mapForPaksha = exports.PAKSHA_MAP[normPaksha] || exports.PAKSHA_MAP.Shukla;
    return mapForPaksha[language] || mapForPaksha.hinglish || paksha;
}
exports.NATURE_BADGE_MAP = {
    AUSPICIOUS: {
        hinglish: 'Auspicious',
        hi: 'शुभ',
        gu: 'શુભ',
...
function getLocalizedNatureBadge(type, language) {
    const badgeMap = exports.NATURE_BADGE_MAP[type] || exports.NATURE_BADGE_MAP.AUSPICIOUS;
    return badgeMap[language] || badgeMap.hinglish || type;
}
exports.NAKSHATRA_MAP = {
    1: {
        hinglish: 'Ashwini',
        hi: 'अश्विनी',
        gu: 'અશ્વિની',
...
function getLocalizedNakshatra(nakshatraVal, language) {
    let index = 1;
    ...
    const nakMap = exports.NAKSHATRA_MAP[index] || exports.NAKSHATRA_MAP[1];
