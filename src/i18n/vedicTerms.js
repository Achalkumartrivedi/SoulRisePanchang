...
exports.PAKSHA_MAP = exports.VAARA_MAP = exports.TITHI_MAP = void 0;
...
function getLocalizedTithi(tithiNumber, language) {
    var normalizedNum = ((tithiNumber - 1) % 15) + 1;
    if (isNaN(normalizedNum) || normalizedNum < 1 || normalizedNum > 15) {
        normalizedNum = 1;
    }
    var mapForNumber = exports.TITHI_MAP[normalizedNum] || exports.TITHI_MAP[1];
...
function getLocalizedPakshaName(paksha, language) {
    var normPaksha = (paksha === 'SHUKLA' || paksha === 'Shukla') ? 'Shukla' : 'Krishna';
    var mapForPaksha = exports.PAKSHA_MAP[normPaksha] || exports.PAKSHA_MAP.Shukla;
