...
export type FestivalCategory = 'MAJOR_FESTIVAL' | 'VRAT' | 'JAYANTI' | 'CULTURAL' | 'ECLIPSE' | 'JAIN_FESTIVAL' | 'SIKH_FESTIVAL' | 'BUDDHIST_FESTIVAL' | 'CHRISTIAN_FESTIVAL' | 'PARSI_FESTIVAL' | 'WORLD_FESTIVAL';
