...
export const VIJAYA_GUIDE: Record<LanguageCode, VijayaGuideContent> = {
  ...
  gu: {
    modalHeaderTitle: '✌️ વિજય સમય (વિજય મુહૂર્ત)',
    subtitle: 'વિજય અને સફળતાનો અત્યંત શુભ સમય. નવા પ્રોજેક્ટ, બિઝનેસ ડીલ, યાત્રા અને મહત્વપૂર્ણ કાર્યો માટે શ્રેષ્ઠ.',
    whatIsTitle: 'વિજય મુહૂર્ત શું છે?',
    whatIsText: 'વિજય મુહૂર્ત એ બપોર પછીનો પવિત્ર શુભ સમય છે જે કાર્યોમાં વિજય, સફળતા અને વિઘ્નો દૂર કરવા માટે જાણીતો છે.',
    meaningTitle: 'અર્થ',
    meaningPoints: [
      'વિજય (Vijaya) = જીત અથવા સફળતા',
      'મુહૂર્ત (Muhurat) = ૪૮ મિનિટનો શુભ સમય'
    ],
    meaningSummary: 'આને "વિજયનો સમય" કહેવામાં આવે છે કારણ કે આ સમયમાં શરૂ કરેલા કાર્યોમાં સફળતા મળવાની સંભાવના સૌથી વધુ હોય છે.',
    timingTitle: 'સમય',
    timingPoints: [
      'બપોર પછી આશરે ૨:૦૦ PM થી ૩:૦૦ PM ની વચ્ચે',
      'આનો કુલ સમય આશરે ૪૮ મિનિટનો હોય છે',
      'સ્થાનિક સૂર્યોદય અને સૂર્યાસ્ત મુજબ બદલાય છે'
    ],
    whySpecialTitle: 'શા માટે વિશેષ છે?',
    whySpecialPoints: [
      'ભગવાન શ્રી રામના વિજય પ્રસંગ સાથે જોડાયેલ',
      'કાર્યોમાં આવતા વિઘ્નો દૂર કરે છે',
      'મહત્વપૂર્ણ સોદાઓમાં આત્મવિશ્વાસ વધારે છે'
    ],
    bestActivitiesTitle: 'આ સમયે શું કરવું?',
    bestActivitiesItems: [
      'નવો વ્યાપાર કે પ્રોજેક્ટ શરૂ કરવો',
      'મહત્વપૂર્ણ કરાર પર સહી કરવી',
      'યાત્રાનો પ્રારંભ',
      'કોર્ટ કચેરી કે કાનૂની કાર્યો',
      'પરીક્ષા કે ઇન્ટરવ્યુ માટે જવું',
      'મિલકત કે વાહનની ખરીદી'
    ],
    quickFactTitle: 'રસપ્રદ તથ્ય',
    quickFactText: 'પૌરાણિક કથા મુજબ ભગવાન શ્રી રામે રાવણ પર વિજય મેળવવા વિજય મુહૂર્તમાં જ પ્રસ્થાન કર્યું હતું.'
  },
  en: {
    modalHeaderTitle: '✌️ Vijaya Time (Vijaya Muhurat)',
