...
export const ABHIJIT_GUIDE: Record<LanguageCode, AbhijitGuideContent> = {
  ...
  gu: {
    modalHeaderTitle: '🌟 અભિજીત સમય (અભિજીત મુહૂર્ત)',
    subtitle: 'અભિજીત મુહૂર્ત હિન્દુ પંચાંગમાં બપોરના (સૂર્ય મધ્યાહ્ન) સમયનો એક અત્યંત પવિત્ર અને શુભ સમય છે. નવા કાર્ય શરૂ કરવા માટે શ્રેષ્ઠ માનવામાં આવે છે.',
    whatIsTitle: 'અભિજીત સમય શું છે?',
    whatIsPoints: [
      'આ સ્થાનિક સૂર્ય મધ્યાહ્ન (Solar Noon) ની આસપાસ થાય છે.',
      'આ આશરે ૪૮ મિનિટ સુધી રહે છે, જેનું મધ્ય બિંદુ સૂર્ય મધ્યાહ્ન હોય છે.',
      'પરંપરાગત રીતે આ સમગ્ર દિવસના સમયનો ૧/૧૫મો ભાગ હોય છે.'
    ],
    exampleText: 'ઉદાહરણ: જો સૂર્યોદય સવારે ૬:૦૦ વાગ્યે અને સૂર્યાસ્ત સાંજે ૬:૦૦ વાગ્યે હોય, તો અભિજીત સમય આશરે ૧૧:૩૬ AM થી ૧૨:૨૪ PM સુધી રહેશે.',
    meaningTitle: 'આને "અભિજીત" કેમ કહેવામાં આવે છે?',
    meaningText: 'સંસ્કૃત શબ્દ અભિજીત (अभिजित) નો અર્થ છે "વિજેતા" અથવા "વિજય અપાવનાર". આ નામ વિજય અને સફળતાનું પ્રતીક છે.',
    auspiciousReasonTitle: 'આ શુભ કેમ માનવામાં આવે છે?',
    auspiciousReasonText: 'વૈદિક પરંપરામાં બપોરના સમયે સૂર્ય તેની ઉચ્ચતમ શક્તિ પર હોય છે, જે સ્પષ્ટતા અને ઊર્જાનું પ્રતીક છે.',
    goodForTitle: 'કયા કાર્યો માટે શુભ છે:',
    goodForItems: [
      'નવો પ્રોજેક્ટ કે વ્યાપાર શરૂ કરવો',
      'વ્યાપારિક કરાર અને સોદા',
      'યાત્રાનો પ્રારંભ',
      'નોકરીના ઇન્ટરવ્યુ અને મહત્વપૂર્ણ બેઠકો',
      'દસ્તાવેજો પર સહી કરવી'
    ],
    avoidTitle: 'કયા કાર્યો ટાળવા:',
    avoidText: 'લગ્ન જેવા વિશેષ ધાર્મિક કાર્યો માટે સંપૂર્ણ કુંડળી આધારિત મુહૂર્ત પસંદ કરવામાં આવે છે.',
    historyTitle: 'ઐતિહાસિક તથ્ય:',
    historyText: 'પ્રાચીન કાળમાં અભિજીતને ૨૮મું નક્ષત્ર માનવામાં આવતું હતું. આજે પણ તે વિજય અને માંગલિકતાનું પ્રતીક છે.'
  },
  en: {
    modalHeaderTitle: '🌟 Abhijit Time (Abhijit Muhurat)',
