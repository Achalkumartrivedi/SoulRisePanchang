...
const RAW_FESTIVALS: Festival[] = [
  ...
  },
  {
    ...
    hindiName: '🪶 श्रीकृष्ण जन्माष्टमी (गुजरात)',
    gujaratiName: '🪶 શ્રીકૃષ્ણ જન્માષ્ટમી (આઠમ) - ગુજરાત',
    dateIso: '2026-09-05',
    category: 'MAJOR_FESTIVAL',
  ...
  },
  {
    ...
    name: '🌺 Sharad Navratri Mahanavami',
    hindiName: '🌺 महानवमी पूजा',
    gujaratiName: '🌺 શારદીય મહા નવમી',
    dateIso: '2026-10-19',
    category: 'MAJOR_FESTIVAL',
  ...
  // ----------------------------------------------------
  // SACRED JAYANTIS (AVATARS, RISHIS, SAINTS & DHARMIC LEADERS)
  // ----------------------------------------------------
  {
    id: 'f_parashurama_jayanti',
    name: '🕉️ Bhagwan Parashurama Jayanti',
    hindiName: '🕉️ भगवान परशुराम जयंती',
    gujaratiName: '🕉️ ભગવાન પરશુરામ જયંતી',
    dateIso: '2026-04-19',
    category: 'JAYANTI',
    deity: 'Bhagwan Parashurama (6th Avatar of Vishnu)',
    description: 'Birth anniversary of Lord Parashurama, the 6th incarnation of Bhagwan Vishnu born on Akshaya Tritiya.',
    rituals: 'Fast (Vrat), Shastra Pujan, Vishnu Sahasranama & Havan.',
    tithiDescription: 'Vaishakha Shukla Tritiya (Akshaya Tritiya)',
    isHoliday: true
  },
  {
    id: 'f_narsimha_jayanti',
    name: '🌾 Bhagwan Narsimha Jayanti',
    hindiName: '🌾 भगवान नृसिंह जयंती',
    gujaratiName: '🌾 ભગવાન નૃસિંહ જયંતી',
    dateIso: '2026-04-30',
    category: 'JAYANTI',
    deity: 'Bhagwan Narsimha (4th Avatar of Vishnu)',
    description: 'Appearance day of Lord Narsimha who manifested to protect Bhakta Prahlada and destroy Hiranyakashipu.',
    rituals: 'Narsimha Sandhya Puja, offering Panchamrit & flowers.',
    tithiDescription: 'Vaishakha Shukla Chaturdashi',
    isHoliday: false
  },
  {
    id: 'f_hanuman_jayanti',
    name: '🐒 Shri Hanuman Jayanti',
    hindiName: '🐒 श्री हनुमान जयंती',
    gujaratiName: '🐒 શ્રી હનુમાન જયંતી',
    dateIso: '2026-04-02',
    category: 'JAYANTI',
    deity: 'Lord Hanuman',
    description: 'Birth anniversary of Lord Hanuman observed on Chaitra Purnima.',
    rituals: 'Sundarkand path, Hanuman Chalisa, offering Sindoor and Boondi prasad.',
    tithiDescription: 'Chaitra Purnima',
    isHoliday: true
  },
  {
    id: 'f_shankaracharya_jayanti',
    name: '🧘 Jagadguru Adi Shankaracharya Jayanti',
    hindiName: '🧘 जगद्गुरु आदि शंकराचार्य जयंती',
    gujaratiName: '🧘 જગદ્ગુરુ આદિ શંકરાચાર્ય જયંતી',
    dateIso: '2026-04-21',
    category: 'JAYANTI',
    deity: 'Adi Shankaracharya',
    description: 'Appearance day of Jagadguru Adi Shankaracharya, revivalist of Advaita Vedanta philosophy.',
    rituals: 'Reading Upadeshasahasri, Shankara Bhashya recital & Vedic chanting.',
    tithiDescription: 'Vaishakha Shukla Panchami',
    isHoliday: false
  },
  {
    id: 'f_guru_purnima_vyas_jayanti',
    name: '🌸 Maharshi Veda Vyasa Jayanti (Guru Purnima)',
    hindiName: '🌸 महर्षि वेदव्यास जयंती (गुरु पूर्णिमा)',
    gujaratiName: '🌸 મહર્ષિ વેદવ્યાસ જયંતી (ગુરુ પૂનમ)',
    dateIso: '2026-07-29',
    category: 'JAYANTI',
    deity: 'Maharshi Veda Vyasa & Spiritual Gurus',
    description: 'Birth anniversary of Maharshi Veda Vyasa, author of Mahabharata and compiler of 4 Vedas. Celebrated as Guru Purnima.',
    rituals: 'Guru Pujan, offering Dakshina & honors to spiritual mentors.',
    tithiDescription: 'Ashadha Purnima',
    isHoliday: true
  },
  {
    id: 'f_valmiki_jayanti',
    name: '📜 Maharshi Valmiki Jayanti',
    hindiName: '📜 महर्षि वाल्मीकि जयंती',
    gujaratiName: '📜 મહર્ષિ વાલ્મીકિ જયંતી',
    dateIso: '2026-10-26',
    category: 'JAYANTI',
    deity: 'Maharshi Valmiki',
    description: 'Birth anniversary of Maharshi Valmiki, Adi Kavi who composed the holy epic Ramayana.',
    rituals: 'Reciting Ramayana, Valmiki Shloka chanting.',
    tithiDescription: 'Ashvin Purnima',
    isHoliday: true
  },
  {
    id: 'f_sant_ravidas_jayanti',
    name: '📜 Sant Ravidas Jayanti',
    hindiName: '📜 संत रविदास जयंती',
    gujaratiName: '📜 સંત રવિદાસ જયંતી',
    dateIso: '2026-02-01',
    category: 'JAYANTI',
    deity: 'Sant Ravidas Ji',
    description: 'Birth anniversary of revered saint-poet Sant Ravidas Ji.',
    rituals: 'Sankirtan, Nagar Kirtan & community langar.',
    tithiDescription: 'Magha Purnima',
    isHoliday: true
  },
  {
    id: 'f_sant_kabir_jayanti',
    name: '📜 Sant Kabir Das Jayanti',
    hindiName: '📜 संत कबीरदास जयंती',
    gujaratiName: '📜 સંત કબીરદાસ જયંતી',
    dateIso: '2026-06-29',
    category: 'JAYANTI',
    deity: 'Sant Kabir Das',
    description: 'Birth anniversary of mystic poet Sant Kabir Das Ji.',
    rituals: 'Reciting Kabir Dohe and Bhajans.',
    tithiDescription: 'Jyeshtha Purnima',
    isHoliday: true
  },
  {
    id: 'f_tulsidas_jayanti',
    name: '🪔 Goswami Tulsidas Jayanti',
    hindiName: '🪔 गोस्वामी तुलसीदास जयंती',
    gujaratiName: '🪔 ગોસ્વામી તુલસીદાસ જયંતી',
    dateIso: '2026-08-19',
    category: 'JAYANTI',
    deity: 'Goswami Tulsidas',
    description: 'Birth anniversary of Goswami Tulsidas Ji, saint-poet author of Shri Ramcharitmanas.',
    rituals: 'Ramcharitmanas Akhand Path & Hanuman Chalisa chanting.',
    tithiDescription: 'Shravana Shukla Saptami',
    isHoliday: false
  },
  {
    id: 'f_dattatreya_jayanti',
    name: '🌾 Bhagwan Dattatreya Jayanti',
    hindiName: '🌾 भगवान दत्तात्रेय जयंती',
    gujaratiName: '🌾 ભગવાન દત્તાત્રેય જયંતી',
    dateIso: '2026-12-23',
    category: 'JAYANTI',
    deity: 'Bhagwan Dattatreya (Trimurti Incarnation)',
    description: 'Birth anniversary of Lord Dattatreya, synthesis of Brahma, Vishnu, and Shiva.',
    rituals: 'Avadhuta Gita reading, Datta Vrat & Deepotsav.',
    tithiDescription: 'Margashirsha Purnima',
    isHoliday: false
  },
  {
    id: 'f_shivaji_jayanti',
    name: '🚩 Chhatrapati Shivaji Maharaj Jayanti',
    hindiName: '🚩 छत्रपति शिवाजी महाराज जयंती',
    gujaratiName: '🚩 છત્રપતિ શિવાજી મહારાજ જયંતી',
    dateIso: '2026-02-19',
    category: 'JAYANTI',
    deity: 'Chhatrapati Shivaji Maharaj',
    description: 'Birth anniversary of Maratha Empire founder Chhatrapati Shivaji Maharaj.',
    rituals: 'Cultural rallies, honoring national valour.',
    tithiDescription: 'Phalguna Krishna Tritiya',
    isHoliday: true
  },
  {
    id: 'f_vivekananda_jayanti',
    name: '🌸 Swami Vivekananda Jayanti (National Youth Day)',
    hindiName: '🌸 स्वामी विवेकानंद जयंती (राष्ट्रीय युवा दिवस)',
    gujaratiName: '🌸 સ્વામી વિવેકાનંદ જયંતી (રાષ્ટ્રીય યુવા દિવસ)',
    dateIso: '2026-01-12',
    category: 'JAYANTI',
    deity: 'Swami Vivekananda',
    description: 'Birth anniversary of Swami Vivekananda, celebrated nationwide as National Youth Day.',
    rituals: 'Youth conventions, yoga sessions & spiritual discourses.',
    tithiDescription: 'Pausha Krishna Saptami',
    isHoliday: false
  },
  // Iconic State-Specific Festivals Across India
  {
    id: 'f_as_bohag_bihu',
    name: '🌾 Bohag Bihu (Rongali Bihu - Assamese New Year)',
    hindiName: '🌾 बोहाग बिहू (रंगाली बिहू - असम)',
    gujaratiName: '🌾 બોહાગ બિહૂ (અસમ)',
    dateIso: '2026-04-15',
    category: 'CULTURAL',
    deity: 'Nature & Harvest',
    description: 'Most joyful harvest festival & spring celebration marking Assamese New Year.',
    rituals: 'Traditional Bihu dance, Husori singing, wearing Gamosa, community feasts.',
    tithiDescription: 'Vaisakha Sankranti',
    region: 'Assam & North East',
    isHoliday: true
  },
  {
    id: 'f_as_ambubachi_mela',
    name: '🌺 Ambubachi Mela (Maa Kamakhya Devi - Assam)',
    hindiName: '🌺 अंबूबाची मेला (माँ कामाख्या देवी - असम)',
    gujaratiName: '🌺 અંબુબાચી મેળો (અસમ)',
    dateIso: '2026-06-22',
    category: 'MAJOR_FESTIVAL',
    deity: 'Maa Kamakhya Devi',
    description: 'Annual Tantric festival celebrating the menstrual cycle of Mother Earth at Kamakhya Temple, Guwahati.',
    rituals: 'Temple doors closed for 3 days, special Angodak and Raktabastra prasad distribution.',
    tithiDescription: 'Ashadha Krishna Navami',
    region: 'Assam & North East',
    isHoliday: false
  },
  {
    id: 'f_or_raja_parba',
    name: '🌸 Raja Parba (Odisha Agricultural Festival)',
    hindiName: '🌸 रजा पर्ब (ओडिशा)',
    gujaratiName: '🌸 રજા પર્બ (ઓડિશા)',
    dateIso: '2026-06-14',
    category: 'CULTURAL',
    deity: 'Bhudevi (Mother Earth)',
    description: 'Unique 3-day festival of Odisha celebrating womanhood and the rejuvenation of Mother Earth.',
    rituals: 'Swinging on decorated rope swings (Dolikas), eating Poda Pitha, no plowing or digging Earth.',
    tithiDescription: 'Mithuna Sankranti',
    region: 'Odisha',
    isHoliday: true
  },
  {
    id: 'f_mh_bail_pola',
    name: '🐂 Bail Pola (Maharashtra Bull & Cattle Worship)',
    hindiName: '🐂 बैल पोला (महाराष्ट्र एवं छत्तीसगढ़)',
    gujaratiName: '🐂 બળદ પોળા (મહારાષ્ટ્ર)',
    dateIso: '2026-09-10',
    category: 'CULTURAL',
    deity: 'Nandi Dev & Cattle',
    description: 'Traditional thanksgiving festival celebrated by farmers in Maharashtra & Chhattisgarh honoring bulls & oxen.',
    rituals: 'Washing, decorating bulls with horns painted, colorful shawls, and grand procession.',
    tithiDescription: 'Shravana Amavasya (Pithori Amavasya)',
    region: 'Maharashtra & Chhattisgarh',
    isHoliday: false
  },
  {
    id: 'f_mh_narali_purnima',
    name: '🥥 Narali Purnima (Maharashtra Coconut Festival)',
    hindiName: '🥥 नारली पूर्णिमा (महाराष्ट्र समुद्र पूजा)',
    gujaratiName: '🥥 નારળી પૂનમ (મહારાષ્ટ્ર)',
    dateIso: '2026-08-28',
    category: 'CULTURAL',
    deity: 'Varuna Dev (Ocean God)',
    description: 'Fisherfolk community festival of coastal Maharashtra & Goa offering coconuts to the Arabian Sea.',
    rituals: 'Offering gilded coconuts to Sea God Varuna, preparing Narali Bhat (sweet coconut rice).',
    tithiDescription: 'Shravana Purnima',
  ...
  },
  {
    ...
    name: '🌕 Kojagari Lakshmi Puja (Bengal & Assam)',
    hindiName: '🌕 कोजागरी लक्ष्मी पूजा (पश्चिम बंगाल एवं असम)',
    gujaratiName: '🌕 કોજાગરી લક્ષ્મી પૂજા',
    dateIso: '2026-10-25',
    category: 'MAJOR_FESTIVAL',
    deity: 'Maa Lakshmi',
    description: 'Grand Kojagari Lokkhi Pujo celebrated on Sharad Purnima night across West Bengal & Assam.',
    rituals: 'Alpona floor art, offering Coconut Naru, Kheer and staying awake (Kojagari) all night for Lakshmi blessings.',
    tithiDescription: 'Ashwina Sharad Purnima',
    region: 'West Bengal & Assam',
    isHoliday: true
  },
  {
    id: 'f_tn_thaipusam',
    name: '🪷 Thaipusam (Lord Murugan Festival - Tamil Nadu)',
    hindiName: '🪷 थाईपूसम (भगवान मुरुगन - तमिलनाडु)',
    gujaratiName: '🪷 થાઈપૂસમ (તમિળનાડુ)',
    dateIso: '2026-02-01',
    category: 'MAJOR_FESTIVAL',
    deity: 'Lord Murugan / Kartikeya',
    description: 'Vibrant Tamil festival commemorating Lord Murugan receiving the sacred Vel (spear) from Parvati Devi.',
    rituals: 'Kavadi Aattam dance, carrying Pal Kudam (milk pots), fasting and temple pilgrimage.',
    tithiDescription: 'Thai Pusam (Pushya Nakshatra)',
    region: 'Tamil Nadu & Kerala',
    isHoliday: true
  },
  {
    id: 'f_hp_kullu_dussehra',
    name: '🚩 Kullu Dussehra (Himachal Pradesh Grand Procession)',
    hindiName: '🚩 कुल्लू दशहरा (हिमाचल प्रदेश)',
    gujaratiName: '🚩 કુલ્લૂ દશેરા (હિમાચલ પ્રદેશ)',
    dateIso: '2026-10-21',
    category: 'MAJOR_FESTIVAL',
    deity: 'Lord Raghunath (Shri Rama)',
    description: 'World-famous 7-day international festival of Kullu Valley starting on Vijayadashami day.',
    rituals: 'Grand Rath Yatra of Lord Raghunath, congregation of over 200 local hill deities (Devtas).',
    tithiDescription: 'Ashwina Shukla Dashami',
    region: 'Himachal Pradesh',
    isHoliday: true
  },
  {
    id: 'f_jk_herath',
    name: '🔱 Herath (Kashmiri Pandit Shivratri)',
    hindiName: '🔱 हेराथ (कश्मीरी पंडित शिवरात्रि)',
    gujaratiName: '🔱 હેરાથ (કશ્મીરી શિવરાત્રિ)',
    dateIso: '2026-02-15',
    category: 'MAJOR_FESTIVAL',
    deity: 'Lord Shiva & Mata Parvati',
    description: 'Most sacred 3-day festival of Kashmiri Pandits celebrating the divine marriage of Hara & Girija.',
    rituals: 'Vatuk Puja with water-filled vessels (Kalash), offering walnuts (Doon), distributing Prasad.',
    tithiDescription: 'Phalguna Krishna Trayodashi (Kashmiri Panchang)',
