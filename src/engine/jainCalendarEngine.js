...
exports.getJainDayData = getJainDayData;
var JAIN_MONTHS = [
 ...
 */
function getJainDayData(date, tithiIndex) {
    var gYear = date.getFullYear();
    // Vira Nirvana Samvat Year = Western Year + 527 (e.g. 2026 CE = Vira Nirvana Samvat 2552)
    var viraSamvatYear = gYear + 527;
    var monthIdx = date.getMonth();
    var jainMonthName = JAIN_MONTHS[monthIdx % 12];
    // Normalized Tithi (0-14 = Sud/Shukla, 15-29 = Vad/Krishna)
    var tithiNum = (tithiIndex % 15) + 1;
    var isSud = tithiIndex < 15;
    var pakshaName = isSud ? 'Sud (Waxing)' : 'Vad (Waning)';
    var tithiNames = [
    ...
    var jainTithiName = "".concat(pakshaName, " ").concat(tithiNames[tithiNum - 1]);
    // Check if date falls in 4-Month Holy Chaturmas Period (July 29 to Nov 24, 2026)
    var month = date.getMonth(); // 0-indexed (6 = July, 10 = Nov)
    var day = date.getDate();
    var isInChaturmas = false;
    var chaturmasStatus = 'Regular Period';
    ...
    var isParvaTithi = false;
    var parvaType = undefined;
    var pachkhanInfo = undefined;
    var religiousActivities = [
    ...
    var jainFestivalName = undefined;
    ...
    return {
        viraSamvatYear: viraSamvatYear,
        jainMonthName: jainMonthName,
        jainTithiName: jainTithiName,
        isParvaTithi: isParvaTithi,
        parvaType: parvaType,
        jainFestivalName: jainFestivalName,
        pachkhanInfo: pachkhanInfo,
        isInChaturmas: isInChaturmas,
        chaturmasStatus: chaturmasStatus,
